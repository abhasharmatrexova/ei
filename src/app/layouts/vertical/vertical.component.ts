...
export class VerticalComponent {
  ...
  constructor(private router: Router,private apiService:ApiService, private route: ActivatedRoute,private readonly keycloak: KeycloakService) { }
  ...
  this.setKeycloakId();
  this.setUserIdGlobally();
  this.setRoleGlobally();
  ...
  setKeycloakId() {
       this.keycloakId = this.keycloak.getKeycloakInstance().idTokenParsed?.sub;
       localStorage.setItem('keycloakId',this.keycloakId);
  }

  setUserIdGlobally() {
    this.apiService.getLoginUser().subscribe((data)=>{
